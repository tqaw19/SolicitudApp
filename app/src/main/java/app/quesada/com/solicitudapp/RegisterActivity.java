...
public class RegisterActivity extends AppCompatActivity {
    ...
    public void callRegister(View view) {
        ...
        if (motivo.isEmpty() || correo.isEmpty()) {
            Toast.makeText(this, "Motivo y correo son campos requeridos", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if (mediaFileUri == null) {
            ...
            call = service.createSolicitud(motivo, correo, tipo);
        } else {
            ...
            MultipartBody.Part imagenPart = MultipartBody.Part.createFormData("captura", file.getName(), requestFile);
            ...
            call = service.createSolicitudWithImage(motivoPart, correoPart, tipoPart, imagenPart);
        }
